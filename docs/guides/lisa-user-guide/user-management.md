...
1. Select **Users** from main navigation menu in the Dashboard.
   ![Users Menu Item Screenshot](/img/screenshots/dashboard_users.png)
2. Click on the **+ create** button.
   ![Create-User button Screenshot](/img/screenshots/create_user_button.png)
3. Fill in the user’s details:
   ...
   - \*\* Other otional fields
     ...
     ![Create-User form Screenshot](/img/screenshots/create_user_form.png)

4. Click **Create User**.

The user will receive an email or WhatsApp message with a link to log in.
![Welcome Email Screenshot](/img/screenshots/welcome_email.png)
